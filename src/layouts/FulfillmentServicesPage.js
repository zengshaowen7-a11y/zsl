      ...
      <section className="fsp-hero">
        ...
        <div className="container fsp-hero-grid">
          ...
          <div className="fsp-hero-visual">
            <Image className="fsp-hero-photo" src="/images/jw-content/receiving-team.webp" alt="JW receiving team scanning incoming cartons" fill priority sizes="(max-width: 991px) 100vw, 48vw" unoptimized />
